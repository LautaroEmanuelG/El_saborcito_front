...
export const Web = () => {
  ...
  // Determinar si el carrusel y las categorías deben ocultarse
  const shouldHideCarouselAndCategories = searchTerm && filteredProducts.length > 0;
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 w-full">
      ...
      <div className="container mx-auto px-4 md:px-6 py-4 flex flex-col min-h-screen w-full">
        {!shouldHideCarouselAndCategories && (
          <>
            <ActiveSlider />
            <ListaCategorias />
          </>
