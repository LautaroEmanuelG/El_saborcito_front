      ...
      {insumosFiltrados.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-6">
          <div className="bg-white p-3 sm:p-4 rounded-lg shadow border-l-4 border-red-500">
            <div className="text-lg sm:text-2xl font-bold text-red-600">{insumosCriticos}</div>
            <div className="text-xs sm:text-sm text-gray-600">Stock Crítico</div>
          </div>

          <div className="bg-white p-3 sm:p-4 rounded-lg shadow border-l-4 border-orange-500">
            <div className="text-lg sm:text-2xl font-bold text-orange-600">{insumosLow}</div>
            <div className="text-xs sm:text-sm text-gray-600">Stock Bajo</div>
          </div>

          <div className="bg-white p-3 sm:p-4 rounded-lg shadow border-l-4 border-yellow-500">
            <div className="text-lg sm:text-2xl font-bold text-yellow-600">{insumosCerca}</div>
            <div className="text-xs sm:text-sm text-gray-600">Cerca del Mínimo</div>
          </div>
        </div>
      )}
