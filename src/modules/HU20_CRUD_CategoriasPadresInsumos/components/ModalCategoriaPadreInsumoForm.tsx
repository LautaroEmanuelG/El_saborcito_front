...
interface ModalCategoriaPadreInsumoFormProps {
  open: boolean;
  onClose: () => void;
...
const ModalCategoriaPadreInsumoForm: React.FC<ModalCategoriaPadreInsumoFormProps> = ({
  open,
  onClose,
  initialValues,
  onSubmit,
...
export default ModalCategoriaPadreInsumoForm;
